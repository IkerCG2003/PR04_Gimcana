...
@section('content')
    ...
    <div class="editar">
        ...
        @endif
        <form class="formAgregarGimcana" id="formAgregarGimcana" action="{{ route('admin.crearGimcana') }}"
            method="POST">
            @csrf
            ...
            <textarea id="descripcion" name="descripcion" rows="4" class="scrolleditar" required>{{ old('descripcion_gimcana') }}</textarea>
