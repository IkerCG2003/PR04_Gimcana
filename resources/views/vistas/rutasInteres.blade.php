@if (session('nombre') && session('apellido') && session('email') && session('rol'))
    ...
    <body>
                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                        ...
                        <div class="offcanvas-body">
                            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href=" {{ route('mapa') }} "><i class="fa-solid fa-arrow-left"></i></i> Volver </a>
                                </li>
        ...
        <!-- JavaScript -->
        <script src="{{ asset('/js/rutasInteres.js') }}"></script>
    </body>
